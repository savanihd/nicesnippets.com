...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
	<head>
		...
		<!-- THEME CSS -->
		<link href="{{ asset('newTheme/css/essentials.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('newTheme/css/layout.css') }}" rel="stylesheet" type="text/css" />

		<!-- PAGE LEVEL SCRIPTS -->
		<link href="{{ asset('newTheme/css/header-1.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('newTheme/css/color_scheme/green.css') }}" rel="stylesheet" type="text/css" id="color_scheme" />
	</head>
	...
	<body class="smoothscroll enable-animation">
				...
				<header id="topNav">
					<div class="container">
						...
						<a class="logo pull-left" href="index.html">
							<img src="{{ asset('newTheme/images/logo_dark.png') }}" alt="" />
						</a>
									...
									<li class="dropdown active"><!-- BLOG -->
										...
										<ul class="dropdown-menu">
											...
											<li class="dropdown active">
												...
												<ul class="dropdown-menu">
													<li class="active"><a href="blog-single-default.html">DEFAULT</a></li>
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9">
							...
							<div class="owl-carousel buttons-autohide controlls-over" data-plugin-options='{"items": 1, "autoPlay": 4500, "autoHeight": false, "navigation": true, "pagination": true, "transitionStyle":"fadeUp", "progressBar":"false"}'>
								<a class="lightbox" href="{{ asset('newTheme/images/3-min.jpg') }}" data-plugin-options='{"type":"image"}'>
									<img class="img-responsive" src="{{ asset('newTheme/images/3-min.jpg') }}" alt="" />
								</a>
								<a class="lightbox" href="{{ asset('newTheme/images/3-min.jpg') }}" data-plugin-options='{"type":"image"}'>
									<img class="img-responsive" src="{{ asset('newTheme/images/3-min.jpg') }}" alt="" />
								</a>
		...
		<!-- JAVASCRIPT FILES -->
		<script type="text/javascript">var plugin_path = 'newTheme/plugins/';</script>
		...
		<!-- <script async type="text/javascript" src="{{ asset('newTheme/plugins/styleswitcher/styleswitcher.js') }}"></script> -->
	</body>
</html>