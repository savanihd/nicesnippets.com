...
<section class="content-header">
	<div class="row">
		<div class="col-md-6">
  			<h2>Manage Tutorial</h2>
		</div>
		<div class="col-md-6 text-right content-header-btn">
			<a href="{{ route('tutorials.create') }}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Create New Tutorial</a>
		</div>
	</div>
</section>
