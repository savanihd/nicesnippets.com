...
<section class="content-header">
	<div class="row">
		...
		<div class="col-md-6 text-right content-header-btn">
			<a href="{{ route('blogs.create') }}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Create New Blog</a>
      <button class="btn btn-primary btn-flat search-modules"><i aria-hidden="true" class="fa fa-search"></i> Search</button>
		</div>
	</div>
</section>
    ...
    <div class="box-body table-responsive  no-padding">
      <table class="table table-hover">
        <tr>
          ...
          <th width="90px">Create Date</th>
          <th width="170px">Action</th>
        </tr>
        <tbody>
          @include('admin.blog.data')
        </tbody>
      </table>
    </div>
  </div>
